      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-8 sm:px-6 lg:grid-cols-[1.2fr_1fr]">
        ...
        <div>
          <Link to="/" className="inline-flex items-center gap-3 text-lg font-bold text-gray-900 dark:text-gray-100">
            <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#C05A3E] text-[#FAF7F0] shadow-sm">
              <GraduationCap className="h-5 w-5" />
            </span>
            <span>Edu<span className="text-[#C05A3E] dark:text-[#C05A3E]">Match</span></span>
          </Link>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="mt-3 grid gap-2">
              {links.map(({ href, label, icon: Icon }) => (
                <Link 
                  key={href} 
                  to={href} 
                  className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-[#C05A3E] dark:text-gray-400 dark:hover:text-[#C05A3E] transition-colors"
                >
                  <Icon className="h-4 w-4 text-[#C05A3E] dark:text-[#C05A3E]" />
                  {label}
                </Link>
              ))}
            </div>
          ...
          <div>
            ...
            <p className="mt-3 inline-flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
              <Mail className="h-4 w-4 text-[#C05A3E] dark:text-[#C05A3E]" />
              support@edumatch.vn
            </p>
          </div>
        </div>
