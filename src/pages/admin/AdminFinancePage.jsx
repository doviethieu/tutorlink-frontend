...
const styles = {
  container: { backgroundColor: '#0f172a', minHeight: '100vh', padding: '30px 4%', color: '#e2e8f0', fontFamily: 'Arial, sans-serif' },
  header: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '16px', backgroundColor: '#1e293b', border: '1px solid #334155', borderRadius: '12px', padding: '24px', marginBottom: '22px', flexWrap: 'wrap' },
  badge: { color: '#38bdf8', backgroundColor: 'rgba(56,189,248,0.12)', padding: '5px 10px', borderRadius: '6px', fontSize: '11px', fontWeight: 700, textTransform: 'uppercase' },
  title: { margin: '12px 0 6px', color: '#fff', fontSize: '26px' },
  ...
  metricCard: { backgroundColor: '#1e293b', border: '1px solid #334155', borderRadius: '10px', padding: '18px' },
  metricLabel: { display: 'block', color: '#94a3b8', fontSize: '13px', marginBottom: '8px' },
  metricValue: { color: '#fff', fontSize: '24px' },
  card: { backgroundColor: '#1e293b', border: '1px solid #334155', borderRadius: '12px', padding: '22px', marginBottom: '22px' },
  sectionTitle: { margin: '0 0 16px', fontSize: '17px', color: '#fff' },
  table: { display: 'flex', flexDirection: 'column', gap: '10px' },
  row: { display: 'grid', gridTemplateColumns: 'minmax(220px, 1.5fr) 140px 130px minmax(160px, auto)', gap: '12px', alignItems: 'center', backgroundColor: '#0f172a', border: '1px solid #334155', borderRadius: '8px', padding: '12px 14px' },
  muted: { margin: '4px 0 0', color: '#94a3b8', fontSize: '12px' },
  status: { color: '#cbd5e1', fontSize: '13px', fontWeight: 700 },
  actions: { display: 'flex', gap: '8px', flexWrap: 'wrap' },
  primaryBtn: { backgroundColor: '#38bdf8', color: '#0f172a', border: 'none', borderRadius: '7px', padding: '8px 12px', fontWeight: 700, cursor: 'pointer' },
  dangerBtn: { backgroundColor: '#ef4444', color: '#fff', border: 'none', borderRadius: '7px', padding: '8px 12px', fontWeight: 700, cursor: 'pointer' },
  secondaryBtn: { backgroundColor: 'transparent', color: '#cbd5e1', border: '1px solid #475569', borderRadius: '7px', padding: '9px 14px', fontWeight: 700, cursor: 'pointer' },
  empty: { color: '#94a3b8', textAlign: 'center', margin: 0, padding: '20px' },
  configGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '16px' },
  configItem: { backgroundColor: '#0f172a', border: '1px solid #334155', borderRadius: '8px', padding: '16px' },
  label: { display: 'block', color: '#cbd5e1', fontWeight: 700, fontSize: '13px', marginBottom: '8px' },
  input: { width: '100%', boxSizing: 'border-box', backgroundColor: '#1e293b', border: '1px solid #334155', color: '#fff', borderRadius: '7px', padding: '10px 12px' },
};
