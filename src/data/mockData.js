// =========================================================
// 1. DANH SÁCH GIA SƯ (TUTORS MOCK DATA)
// =========================================================
export const tutors = [
  {
    id: 'mai-anh',
...
// =========================================================
// 2. DANH SÁCH LỊCH HỌC (BOOKINGS MOCK DATA)
// =========================================================
...
// ID của các gia sư nằm trong danh sách yêu thích
export const favoriteTutorIds = ['mai-anh', 'linh-chi'];

// =========================================================
// 3. DANH SÁCH ĐÁNH GIÁ (REVIEWS MOCK DATA)
// =========================================================
...
// =========================================================
// 4. DANH SÁCH CHỜ DUYỆT CỦA ADMIN (ADMIN QUEUE)
// =========================================================
...
// =========================================================
// 5. QUẢN LÝ TÀI KHOẢN NGƯỜI DÙNG (ADMIN USERS)
// =========================================================
...
// =========================================================
// 6. BÁO CÁO VI PHẠM (ADMIN REPORTS)
// =========================================================
export const adminReports = [
  ...
  },
  {
    ...
    description: 'Học sinh hủy lịch sát giờ và cần admin kiểm tra lịch sử booking.',
    severity: 'high',
...
// =========================================================
// 8. CHUỖI DỮ LIỆU BIỂU ĐỒ (SERIES DATA)
// =========================================================
...
// =========================================================
// 9. HÀM ĐỊNH DẠNG ĐƠN VỊ TIỀN TỆ (FORMAT HELPERS)
// =========================================================
export function formatVnd(value) {
  return new Intl.NumberFormat('vi-VN').format(value) + ' ₫';
}

export function formatVndMillion(value) {
